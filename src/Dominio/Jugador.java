...
public class Jugador implements Comparable<Jugador>,Serializable  {
    ...
    public void agregarPartidasJugada(){
        this.cantPartidas++;
    }
    public void agregarPartidasGanadas(){
        this.cantGanadas++;
    }
    public void agregarPartidaEmpatada(){
        this.cantEmpatadas++;
        
    }
    public void agregarPuntos(int cantPuntosGanados){
        this.cantPuntos+=cantPuntosGanados;
    }
