...
public class VentanaAgregarJugador extends javax.swing.JFrame {
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        if (texfAlias.getText().isEmpty() || texfNombre.getText().isEmpty()) {
            txtlAlerta.setText("COMPLETE TODOS LOS CAMPOS");
        }else {
            if (Sistema.getInstance().aliasUnico(texfAlias.getText())) {
                txtlAlerta.setText("JUGADOR INGRESADO CORRECTAMENTE");
                Jugador j = new Jugador(texfNombre.getName(),texfAlias.getText(),(int) jsEdad.getValue());
                Sistema.getInstance().addPlayer(j);
            }else{
                txtlAlerta.setText("EL JUGADOR YA EXISTE INTENTE CON OTRO ALIAS");
            }
        }
