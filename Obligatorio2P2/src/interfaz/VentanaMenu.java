...
public class VentanaMenu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(btnMusica, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 10, -1, 40));
    ...
    private void btnRegistrarJugadorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarJugadorActionPerformed
        VentanaAgregarJugador vent = new VentanaAgregarJugador(this);
        vent.setLocation(this.getLocation());
    ...
    private Reproductor unReproductor;
}
